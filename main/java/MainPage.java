...
public class MainPage {
    ...
    private final By cookieButton = By.id("App_CookieButton__3cvqF"); //поп-ап с кнопкой принять куки
    private final By headerOrderButton = By.className("Button_Button__ra12g"); //кнопка Заказать вверху страницы
    private final By belowOrderButton= By.className("Button_UltraBig__UU3Lp"); //кнопка заказать, которая по-середине
